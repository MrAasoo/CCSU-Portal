...
import com.college.portal.modules.classroom.adapter.DiscussionRoomAdapter;
...
public class ClassDiscussionActivity extends AppCompatActivity {

    // news list
    private RecyclerView recyclerView;
    private DiscussionRoomAdapter mAdapter;
    private List<DiscussionRoom> mList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAdapter = new DiscussionRoomAdapter(ClassDiscussionActivity.this, mList);
        recyclerView.setAdapter(mAdapter);

        SharedPrefManager instance = SharedPrefManager.getInstance(ClassDiscussionActivity.this);
        if (instance.isLoggedIn()) {
            StudentPref studentPref = instance.getStudentInfo();
            getClassRoomDiscussion(studentPref.getStdId());
        } else {
            toLoginActivity();
        }
    }
    ...
    private void toLoginActivity() {
        Intent intent = new Intent(ClassDiscussionActivity.this, SignInActivity.class);
    ...
    //Get Classroom discussion list

    private void getClassRoomDiscussion(String stdId) {

        final ProgressDialogInterface progressDialog = new ProgressDialogInterface(
                ClassDiscussionActivity.this,
        ...
        Call<JsonObject> call = RetrofitClient.getInstance()
                .getRetroApi()
                .getClassroomDiscussionList(stdId);
            ...
            if (obj.optBoolean("status")) {
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    if (!jsonObject.getString("room_id").equals("null")) {
                        ...
                        Toast.makeText(this, "No Discussion Rooms found.", Toast.LENGTH_SHORT).show();
                    }
                }
