package com.college.portal.modules.gallery.adapter;
...
import com.college.portal.modules.gallery.CollegeGalleryVideoActivity;
...
public class GalleryVideoAdapter extends RecyclerView.Adapter<GalleryVideoAdapter.ViewHolder> {
    ...
    public GalleryVideoAdapter(Context mContext, List<Gallery> mList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_video, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardHolder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, CollegeGalleryVideoActivity.class);
                intent.putExtra(AppApi.MEDIA_PATH, mList.get(holder.getAdapterPosition()).getMediaPathVideo());
