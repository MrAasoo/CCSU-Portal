...
import com.college.portal.modules.student_zone.adapter.SubjectAdapter;
import com.college.portal.modules.student_zone.model.Subject;
...
public class SubjectListActivity extends AppCompat {
    ...
    private void writeRecycler(String jsonResponse) {
        try {
            ...
            if (obj.optBoolean("status")) {
                ...
                AlertDialogInterface dialog = new AlertDialogInterface(SubjectListActivity.this,
                        "No result found!",
