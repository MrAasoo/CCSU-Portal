...
public class AssignmentActivity extends AppCompat {
    ...
    private void writeRecycler(String jsonresponse) {
        try {
            ...
            if (obj.optBoolean("status")) {
                ...
                if (jsonObject.getString("assi_path").equals("null")) {
                    downloadBtn.setVisibility(View.GONE);
                    openBtn.setVisibility(View.GONE);
                } else {
                    downloadOpenFile(jsonObject.getString("assi_path"));
                }
    ...
    private void downloadOpenFile(final String assi_path) {
        ...
        if (myFile.exists()) {
            ...
            openBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (hasStoragePermission()) {
                        Uri uri = FileProvider.getUriForFile(AssignmentActivity.this, "com.college.portal" + ".provider", myFile);
            ...
            downloadBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (hasStoragePermission()) {
                        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(RetroApi.ASSIGNMENT_FILE_PATH + assi_path + ""));
    ...
    private void requestStoragePermission(int requestCode) {
        ActivityCompat.requestPermissions(AssignmentActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, requestCode);
    }

    private boolean hasStoragePermission() {
        return (ContextCompat.checkSelfPermission(AssignmentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) &&
                (ContextCompat.checkSelfPermission(AssignmentActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == AppApi.STORAGE_PERMISSION) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(AssignmentActivity.this, "Phone Permission Granted", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(AssignmentActivity.this, "Phone Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
